...
@Profile("production")
@Repository
public class OtherUserRepository implements IUserRepository<User, Long> {
  private static final Logger LOGGER = LoggerFactory.getLogger(OtherUserRepository.class);
